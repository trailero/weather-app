...
const toogleSearch = () => searchView.classList.toggle("active");
addEventOnElement(searchTooglers, "click", toogleSearch);
        ...
        for (const { name, lat, lon, country, state } of locations) {
          ...
          searchItem.innerHTML = `
              <span class="m-icon">location_on</span>
                ...
                <a href="#/weather?${lat}&${lon}" class="item-link has-state" aria-label="${name} weather" data-search-toggler></a>
          `;
          searchResult
...
export const updateWeather = function (lat, lon) {
  ...
  fetchData(url.currentWeather(lat, lon), function (currentWeather) {
    ...
    card.innerHTML = `
      <h2 class="title-2 card-tile">Now</h2>
      <div class="weapper">
                  ...
                  <div class="card-list">
                    <div class="card-item">
                      ...
                      <div>
                        ...
                        <p class="title-1">${module.getHours(
                          sunriseUnixUTC,
                          timezone
                        )}</p>
                      </div>
                ...
                <div class="card card-sm highlight-card">
                  ...
                  <div class="wrapper">
                    ...
                    <p class="title-1">${parseInt(
                      module.celsiusToFahrenheit(feels_like)
                    )}&deg;<sup>F</sup></p>
                  </div>
                </div>
              </div>
          ...
          <div class="icon-wrapper">
            ...
            <span class="span">
              <p class="title-2">${parseInt(
                module.celsiusToFahrenheit(temp_max)
              )}&degF</p>
            </span>
          </div>
